export image_name := env("IMAGE_NAME", "tanzanite") # output image name, usually same as repo name, change as needed
...
# Example: just _rebuild-bib localhost/fedora latest qcow2 disk_config/disk.toml
_rebuild-bib $target_image $tag $type $config: (build-aurora tag) && (_build-bib target_image tag type config)
